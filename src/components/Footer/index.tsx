...
class Footer extends React.Component {
  ...
  styling = {
    ...
    form: "",
    input: "rounded-[10px] mt-[54px] bg-[#ebebeb99] w-64 sm:w-2/3 md:w-5/6 xl:w-[763px] h-12 sm:h-[63px] text-center",
    ...
    return (
      <div>
        <div className="font-[montserrat]
          ...
          <div className="pt-8 leading-4 sm:text-sm sm:text-base md:text-lg lg:text-3xl 2xl:text-5xl text-[#06080F]">
