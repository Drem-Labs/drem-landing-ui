      ...
      <div className="relative bg-white shadow-[0_-8px_6px_6px_rgba(0,0,0,0.25)] z-30">
        ...
        <div className="sm:text-left">
          <Subheading layout={'sm:flex sm:flex-row'}
                      ...
                      img_pos={"object-contain w-[817px] 3xl:w-[1225px] sm:mr-96 sm:pl-24 pt-4 sm:pt-36 2xl:pt-96"}
                      text_pos={"ml-3 sm:ml-36 2xl:ml-80 3xl:ml-[800px] pt-36 2xl:pt-96"}
                      title_pos={"mb-[25px]"}
        ...
        <div className="sm:text-left">
          <Subheading layout={'sm:flex sm:flex-row'}
                      ...
                      img_pos={"w-[300px] sm:w-[450px] 2xl:w-[650px] object-contain sm:mr-48 2xl:mr-96 pl-24 2xl:pl-48 mt-[40px] 2xl:mt-[80px]"}
                      text_pos={"mx-3 sm:ml-36 2xl:ml-80 3xl:ml-[800px] sm:pt-12 2xl:pt-32"}
