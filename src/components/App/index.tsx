      ...
      <div className="relative bg-white shadow-[0_-8px_6px_6px_rgba(0,0,0,0.25)] z-30">
        ...
        <div className="text-center sm:text-left">
          <Subheading layout={'sm:flex sm:flex-row'}
                      ...
                      text_pos={"mx-8 sm:mr-0 sm:ml-16 lg:ml-24 xl:ml-36 pt-36 2xl:pt-96"}
        ...
        <div className="text-center sm:text-right">
          <Subheading layout={'sm:flex sm:flex-row-reverse'}
                      ...
                      text_pos={"mx-8 sm:ml-0 sm:mr-16 xl:mr-36 pt-24 sm:pt-36 sm:pt-8 pb-8 3xl:pb-0"}
                      title_pos={"mb-0 lg:mb-[25px]"}
        ...
        <div className="text-center sm:text-left">
          <Subheading layout={'sm:flex sm:flex-row'}
                      ...
                      img_pos={"object-contain w-[300px] sm:w-1/2 lg:w-5/12 xl:w-1/3 2xl:w-[650px] sm:mr-16 lg:mr-16 xl:mr-72 2xl:mr-96 mx-auto px-8 2xl:pl-48 pt-8 sm:pt-0"}
                      text_pos={"mx-8 sm:mr-0 sm:ml-16 lg:ml-24 xl:ml-72 sm:pb-16"}
