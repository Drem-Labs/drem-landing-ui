      ...
      <div className="relative bg-white shadow-[0_-8px_6px_6px_rgba(0,0,0,0.25)] z-30">
        ...
        <div className="sm:text-right">
          <Subheading layout={'sm:flex sm:flex-row-reverse'}
                      ...
                      img_pos={"object-contain w-[350px] sm:w-7/12 md:w-2/3 lg:w-7/12 xl:w-1/2 2xl:w-[1050px] sm:ml-12 md:ml-9 xl:ml-36 sm:pr-16 pl-8 sm:pl-0 md:pr-8"}
                      text_pos={"ml-8 mr-8 sm:ml-0 sm:mr-16 md:mr-10 lg:mr-13 xl:mr-36 pt-24 sm:pt-36 sm:pt-8 pb-8 3xl:pb-0"}
                      title_pos={"mb-0 lg:mb-[25px]"}
