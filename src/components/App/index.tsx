      ...
      <div className="relative bg-white shadow-[0_-8px_6px_6px_rgba(0,0,0,0.25)] z-30">
        ...
        <div className="text-center sm:text-left">
          <Subheading layout={'sm:flex sm:flex-row'}
                      ...
                      img_pos={"object-contain w-[350px] sm:w-1/2 lg:w-7/12 xl:w-1/2 2xl:w-[1050px] sm:mr-16 pl-8 sm:pl-16 lg:-ml-16 xl:mr-36 lg:pl-32 pt-16 sm:pt-36 2xl:pt-[360px]"}
        ...
        <div className="text-center sm:text-right">
          <Subheading layout={'sm:flex sm:flex-row-reverse'}
                      ...
                      img_pos={"object-contain w-[350px] sm:w-7/12 xl:w-1/2 2xl:w-[1050px] sm:ml-12 lg:ml-16 xl:ml-36 sm:pr-16 pl-8 sm:pl-0 md:pr-8"}
