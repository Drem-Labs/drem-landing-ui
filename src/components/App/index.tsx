      ...
      <div className="relative bg-white shadow-[0_-8px_6px_6px_rgba(0,0,0,0.25)] z-30">
        ...
        <div className="sm:text-left">
          <Subheading layout={'sm:flex sm:flex-row'}
                      ...
                      img_pos={"object-contain w-[350px] sm:w-1/2 md:w-2/3 2xl:w-[1050px] sm:mr-16 pl-8 sm:pl-16 lg:-ml-16 lg:pl-32 pt-16 sm:pt-36 2xl:pt-[360px]"}
                      text_pos={"ml-8 mr-8 sm:mr-0 sm:ml-12 md:ml-9 lg:ml-14 pt-36 2xl:pt-96"}
        ...
        <div className="sm:text-right">
          <Subheading layout={'sm:flex sm:flex-row-reverse'}
                      ...
                      img_pos={"object-contain w-[350px] sm:w-7/12 md:w-2/3 lg:w-7/12 2xl:w-[1050px] sm:ml-12 md:ml-9 sm:pr-16 pl-8 sm:pl-0 md:pr-8"}
                      text_pos={"ml-8 mr-8 sm:ml-0 sm:mr-16 md:mr-10 lg:mr-13 pt-24 sm:pt-36 sm:pt-8 pb-8 3xl:pb-0"}
                      title_pos={"mb-0 lg:mb-[25px]"}
        ...
        <div className="sm:text-left">
          <Subheading layout={'sm:flex sm:flex-row'}
                      ...
                      img_pos={"object-contain w-[300px] sm:w-1/2 xl:w-5/12 2xl:w-[650px] sm:mr-16 md:mr-10 2xl:mr-96 pl-20 2xl:pl-48 pt-8 sm:pt-0"}
                      text_pos={"ml-8 mr-8 sm:mr-0 sm:ml-12 md:ml-9 lg:ml-40 sm:pb-16"}
