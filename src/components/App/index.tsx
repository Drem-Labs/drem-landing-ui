      ...
      <div className="relative bg-white shadow-[0_-8px_6px_6px_rgba(0,0,0,0.25)] z-30">
        ...
        <div className="sm:text-left">
          <Subheading layout={'sm:flex sm:flex-row'}
                      ...
                      img_pos={"object-contain w-[350px] sm:w-[650px] 2xl:w-[1050px] sm:mr-36 pl-8 sm:pl-16 pt-16 sm:pt-36 2xl:pt-[360px]"}
                      text_pos={"ml-8 mr-8 sm:mr-0 sm:ml-36 pt-36 2xl:pt-96"}
                      title_pos={"mb-[25px]"}
        ...
        <div className="sm:text-right">
          <Subheading layout={'sm:flex sm:flex-row-reverse'}
                      ...
                      img_pos={"object-contain w-[350px] sm:w-[650px] 2xl:w-[1050px] sm:ml-36 sm:pr-16 pl-8 sm:pl-0"}
                      text_pos={"ml-8 mr-8 sm:ml-0 sm:mr-36 pt-24 sm:pt-36 sm:pt-8 pb-8 3xl:pb-0"}
                      title_pos={"mb-[25px]"}
        ...
        <div className="sm:text-left">
          <Subheading layout={'sm:flex sm:flex-row'}
                      ...
                      img_pos={"object-contain w-[300px] sm:w-[450px] 2xl:w-[650px] sm:mr-72 2xl:mr-96 pl-20 2xl:pl-48 pt-8 sm:pt-0"}
                      text_pos={"ml-8 mr-8 sm:mr-0 sm:ml-72 sm:pb-16"}
